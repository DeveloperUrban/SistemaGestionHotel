...
<div id="app"> <!--Se crea este div para poder darle al acceso a componente de vue-->
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="i#"><i class="icon-wallet"></i> Categórias</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="i#"><i class="icon-basket-loaded"></i>Habitaciones</a>
                            </li>
                            <li class="nav-item">
