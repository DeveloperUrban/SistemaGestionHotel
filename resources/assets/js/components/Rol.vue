                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <button type="submit" @click="listarRol(1,buscar,criterio)" class="btn btn-secondary"><i class="fa fa-search"></i> Buscar</button>
                                </div>
                            </div>
                        </div>
            ...
            desactivarRol(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/rol/desactivar',{
                        ...
                        Swal.fire(
                        'Desactivado',
                        'La Rol ha sido desactivado satisfactoriamente',
                        'success'
                    )
                    }).catch(function (error) {
                        console.log(error);
            ...
            activarRol(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/rol/activar',{
                        ...
                        Swal.fire(
                        'Activado',
                        'La Rol ha sido activado satisfactoriamente',
                        'success'
                    )
                    }).catch(function (error) {
