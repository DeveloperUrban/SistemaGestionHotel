            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> SubCategorías
                        <button type="button" @click="abrirModal('subcategoria','registrar')" class="btn btn-secondary">
                        ...
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody>
                                <tr v-for="subcategoria in arraySubcategoria" :key="subcategoria.id">
                                    <td>
                                        <button type="button" @click="abrirModal('subcategoria','actualizar',subcategoria)" class="btn btn-warning btn-sm">
                                          <i class="icon-pencil"></i>
                                        </button> &nbsp;
                                        <template v-if="subcategoria.condicion">
                                            <button type="button" class="btn btn-danger btn-sm" @click="desactivarSubcategoria(subcategoria.id)">
                                                <i class="icon-trash"></i>
                                            </button>
                                        </template>
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarSubcategoria(subcategoria.id)">
                                                <i class="icon-check"></i>
                                            </button>
                                        </template>
                                    </td>
                                    <td v-text="subcategoria.nombre"></td>
                                    <td v-text="subcategoria.descripcion"></td>
                                    <td>
                                        <div v-if="subcategoria.condicion">
                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Nombre de subcategoría">
                                    </div>
                                </div>
                                <div class="form-group row">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-primary" @click="registrarSubcategoria()">Guardar</button>
                            <button type="button" v-if="tipoAccion==2" class="btn btn-primary" @click="actualizarSubcategoria()">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
        ...
        methods : {
            listarSubcategoria (page,buscar,criterio){
                ...
                axios.get(url).then(function (response) {
                    ...
                    me.arraySubcategoria = respuesta.subcategorias.data;
            ...
            desactivarSubcategoria(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/subcategoria/desactivar',{
                        ...
                        Swal.fire(
                        'Desactivado',
                        'La Subcategoria ha sido desactivado satisfactoriamente',
                        'success'
                    )
                    }).catch(function (error) {
                        console.log(error);
            ...
            activarSubcategoria(id){
                ...
                if (result.isConfirmed) {
                    ...
                    axios.put('/subcategoria/activar',{
                        ...
                        Swal.fire(
                        'Activado',
                        'La Subcategoria ha sido activado satisfactoriamente',
                        'success'
                    )
                    }).catch(function (error) {
            ...
            validarSubcategoria(){
                ...
                if (!this.nombre) this.errorMostrarMsjSubcategoria.push("El nombre de la subcategoria no puede estar vacío.");
